<template>
  <div class="quran-page">
    ...
    <div class="row my-4 d-flex justify-content-center">
      <div class="col-10">
        <input
          ...
          placeholder="Оятдан қидиринг (м: الرحمن)"
        ...
        <div v-else-if="filteredAyahs.length === 0 && keyword">
          <p class="text-muted">Ҳеч қандай оят топилмади...</p>
        </div>

        <div v-else-if="filteredAyahs.length > 0">
          <div class="alert alert-success">
            Топилган оятлар сони: {{ filteredAyahs.length }}
          </div>
          <div
          ...
          >
            ...
            <router-link class=" link-underline link-underline-opacity-0" :to="`/qurandet/${ayah.chapter}#${ayah.chapter}${ayah.verse}`">
              <p class="fs-5 arabic-text">{{ ayah.text }}</p></router-link
            >
          </div>
        </div>
      </div>
    ...
    <div class="card shadow-sm container">
      <div class="card-body">
        <h5 class="card-title text-success">Список сур</h5>
        <div class="row">
          <div
            class="col-md-4 mb-3"
